...
export async function createLead(data) {
  try {
    ...
    if (data.userType === "tutor") {
      ...
      //   // x_studio_preferred_tutor_gender : data.preferredGender?.toString() || "No Preference",
      // };
      ...
      leadPayload = {
        ...
        x_studio_locality: data.area || "",
        x_studio_preferred_tutor_gender: data.preferredGender?.toString() || "No Preference",
        x_studio_registration_date: new Date().toISOString().split("T")[0],
      };
    }
